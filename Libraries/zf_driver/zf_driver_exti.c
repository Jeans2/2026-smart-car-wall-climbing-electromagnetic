...
//-------------------------------------------------------------------------------------------------------------------
// 函数简介     EXTI 中断使能
// 参数说明     pin             选择 EXTI 引脚 (可选择范围由 zf_driver_exti.h 中 exti_pin_enum 枚举值确定)
// 返回参数     void
...
//-------------------------------------------------------------------------------------------------------------------
//  函数简介      EXTI 中断初始化
//  参数说明      eru_pin         选择 EXTI 引脚 (可选择范围由 zf_driver_exti.h 中 exti_pin_enum 枚举值确定)
//  参数说明      trigger         设置触发方式
//  返回参数      void
//  使用示例      exti_init(INT0_P32, EXTI_TRIGGER_BOTH);  //初始化P32 为外部中断引脚，双边沿触发
//  备注信息
//-------------------------------------------------------------------------------------------------------------------
