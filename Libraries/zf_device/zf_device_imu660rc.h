...
#define IMU660RC_USE_INTERFACE       SOFT_SPI                        // 默认使用软件 SPI 方式驱动
...
//====================================================硬件 SPI 驱动====================================================
	...
	#define IMU660RC_SPC_PIN            SPI0_CH3_SCLK_P43             	// 硬件 SPI SCK 引脚
	#define IMU660RC_SDI_PIN            SPI0_CH3_MOSI_P40             	// 硬件 SPI MOSI 引脚
	#define IMU660RC_SDO_PIN            SPI0_CH3_MISO_P41              	// 硬件 SPI MISO 引脚
	#define IMU660RC_CS_PIN             (IO_P42)                       	// CS 片选引脚
