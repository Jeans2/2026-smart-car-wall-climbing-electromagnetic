...
// 配置表放 flash（code），避免撑爆 HCONST
static uint8 code dl1a_cfg_buff1[][2] =
{
    {0x88, 0x00},
    {0x80, 0x01},
    {0xFF, 0x01},
...
static uint8 code dl1a_cfg_buff2[][2] =
{
    {0x00, 0x01},
    {0xFF, 0x00},
    {0x80, 0x00},
...
static uint8 code dl1a_cfg_buff3[][2] =
{
    {0xFF, 0x01},
...
static uint8 code dl1a_cfg_buff4[][2] =
{
    {0xFF, 0x01},
    {0x00, 0x00},
    {0xFF, 0x00},
...
uint8 dl1a_init (void)
{
    ...
    // 配置表已移到文件级 dl1a_cfg_buff1~4 (code 段)
    ...
    do
    {
        ...
        for(i = 0; i < (sizeof(dl1a_cfg_buff1) / 2); i++)
        {
            dl1a_write_register(dl1a_cfg_buff1[i][0], dl1a_cfg_buff1[i][1]);
        }
        ...
        for(i = 0; i < (sizeof(dl1a_cfg_buff2) / 2); i++)
        {
            dl1a_write_register(dl1a_cfg_buff2[i][0], dl1a_cfg_buff2[i][1]);
        }
        ...
        for(i = 0; i < (sizeof(dl1a_cfg_buff3) / 2); i++)
        {
            dl1a_write_register(dl1a_cfg_buff3[i][0], dl1a_cfg_buff3[i][1]);
        }
        ...
        for(i = 0; i < (sizeof(dl1a_cfg_buff4) / 2); i++)
        {
            dl1a_write_register(dl1a_cfg_buff4[i][0], dl1a_cfg_buff4[i][1]);
        }
